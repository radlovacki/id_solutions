# Непрограмабилни нискофреквентни RFID тагови

Нискофреквентни непрограмабилни (*Low Frequency (LF) Read-only*) RFID тагови
раде на фреквенцији од 125 kHz. Имају уникатан перманентан идентификациони број
(*Unique ID*), програмирам током производње чипа.

Ови тагови се најчешће користе у системима где је потребна једноставна,
поуздана и јефтина идентификација, без потребе за изменом података у тагу. На
пример:
